...
issue](https://github.com/cisagov/weewx-prometheus-exporter/issues) in
...
request](https://github.com/cisagov/weewx-prometheus-exporter/pulls),
...
```console
cd weewx-prometheus-exporter
pyenv virtualenv <python_version_to_use> weewx-prometheus-exporter
pyenv local weewx-prometheus-exporter
